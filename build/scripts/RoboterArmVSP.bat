...
set DEFAULT_JVM_OPTS="-Dprism.verbose=true" "-Dprism.debug=true" "-Dprism.forceGPU=true" "-Dprism.order=es2,sw" "-Djavafx.animation.fullspeed=true" "-XX:+UseG1GC" "-XX:+UseStringDeduplication"
